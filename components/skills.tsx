      ...
      <div className="flex gap-3 flex-wrap">
        {skill.items.map((sk) => (
          <Badge
            key={sk.name}
            variant="outline"
            className="rounded-md px-3 py-2 bg-secondary/80 dark:bg-accent/80 border-border/60 gap-2 ring-2 ring-(--icon-color)/30 hover:ring-(--icon-color) transition ease-out cursor-default"
